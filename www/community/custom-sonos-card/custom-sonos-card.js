 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var p;v.finalized=!0,v.elementProperties=new Map,v.elementStyles=[],v.shadowRootOptions={mode:"open"},null==d||d({ReactiveElement:v}),(null!==(a=globalThis.reactiveElementVersions)&&void 0!==a?a:globalThis.reactiveElementVersions=[]).push("1.3.0");const y=globalThis.trustedTypes,g=y?y.createPolicy("lit-html",{createHTML:t=>t}):void 0,f=`lit$${(Math.random()+"").slice(9)}$`,b="?"+f,$=`<${b}>`,S=document,_=(t="")=>S.createComment(t),w=t=>null===t||"object"!=typeof t&&"function"!=typeof t,A=Array.isArray,C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,x=/-->/g,k=/>/g,P=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,E=/'/g,T=/"/g,O=/^(?:script|style|textarea|title)$/i,I=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),M=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),R=new WeakMap,U=S.createTreeWalker(S,129,null,!1),D=(t,e)=>{const i=t.length-1,s=[];let o,r=2===e?"<svg>":"",n=C;for(let e=0;e<i;e++){const i=t[e];let a,l,c=-1,d=0;for(;d<i.length&&(n.lastIndex=d,l=n.exec(i),null!==l);)d=n.lastIndex,n===C?"!--"===l[1]?n=x:void 0!==l[1]?n=k:void 0!==l[2]?(O.test(l[2])&&(o=RegExp("</"+l[2],"g")),n=P):void 0!==l[3]&&(n=P):n===P?">"===l[0]?(n=null!=o?o:C,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?P:'"'===l[3]?T:E):n===T||n===E?n=P:n===x||n===k?n=C:(n=P,o=void 0);const h=n===P&&t[e+1].startsWith("/>")?" ":"";r+=n===C?i+$:c>=0?(s.push(a),i.slice(0,c)+"$lit$"+i.slice(c)+f+h):i+f+(-2===c?(s.push(void 0),e):h)}const a=r+(t[i]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==g?g.createHTML(a):a,s]};class N{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,r=0;const n=t.length-1,a=this.parts,[l,c]=D(t,e);if(this.el=N.createElement(l,i),U.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=U.nextNode())&&a.length<n;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(f)){const i=c[r++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+"$lit$").split(f),e=/([.?@])?(.*)/.exec(i);a.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?L:"?"===e[1]?G:"@"===e[1]?F:V})}else a.push({type:6,index:o})}for(const e of t)s.removeAttribute(e)}if(O.test(s.tagName)){const t=s.textContent.split(f),e=t.length-1;if(e>0){s.textContent=y?y.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],_()),U.nextNode(),a.push({type:2,index:++o});s.append(t[e],_())}}}else if(8===s.nodeType)if(s.data===b)a.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(f,t+1));)a.push({type:7,index:o}),t+=f.length-1}o++}}static createElement(t,e){const i=S.createElement("template");return i.innerHTML=t,i}}function z(t,e,i=t,s){var o,r,n,a;if(e===M)return e;let l=void 0!==s?null===(o=i._$Cl)||void 0===o?void 0:o[s]:i._$Cu;const c=w(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(r=null==l?void 0:l._$AO)||void 0===r||r.call(l,!1),void 0===c?l=void 0:(l=new c(t),l._$AT(t,i,s)),void 0!==s?(null!==(n=(a=i)._$Cl)&&void 0!==n?n:a._$Cl=[])[s]=l:i._$Cu=l),void 0!==l&&(e=z(t,l._$AS(t,e.values),l,s)),e}class B{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:i},parts:s}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:S).importNode(i,!0);U.currentNode=o;let r=U.nextNode(),n=0,a=0,l=s[0];for(;void 0!==l;){if(n===l.index){let e;2===l.type?e=new H(r,r.nextSibling,this,t):1===l.type?e=new l.ctor(r,l.name,l.strings,this,t):6===l.type&&(e=new q(r,this,t)),this.v.push(e),l=s[++a]}n!==(null==l?void 0:l.index)&&(r=U.nextNode(),n++)}return o}m(t){let e=0;for(const i of this.v)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class H{constructor(t,e,i,s){var o;this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cg=null===(o=null==s?void 0:s.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=z(this,t,e),w(t)?t===j||null==t||""===t?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==M&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.k(t):(t=>{var e;return A(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.S(t):this.$(t)}A(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.A(t))}$(t){this._$AH!==j&&w(this._$AH)?this._$AA.nextSibling.data=t:this.k(S.createTextNode(t)),this._$AH=t}T(t){var e;const{values:i,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=N.createElement(s.h,this.options)),s);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.m(i);else{const t=new B(o,this),e=t.p(this.options);t.m(i),this.k(e),this._$AH=t}}_$AC(t){let e=R.get(t.strings);return void 0===e&&R.set(t.strings,e=new N(t)),e}S(t){A(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new H(this.A(_()),this.A(_()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class V{constructor(t,e,i,s,o){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=j}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const o=this.strings;let r=!1;if(void 0===o)t=z(this,t,e,0),r=!w(t)||t!==this._$AH&&t!==M,r&&(this._$AH=t);else{const s=t;let n,a;for(t=o[0],n=0;n<o.length-1;n++)a=z(this,s[i+n],e,n),a===M&&(a=this._$AH[n]),r||(r=!w(a)||a!==this._$AH[n]),a===j?t=j:t!==j&&(t+=(null!=a?a:"")+o[n+1]),this._$AH[n]=a}r&&!s&&this.C(t)}C(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class L extends V{constructor(){super(...arguments),this.type=3}C(t){this.element[this.name]=t===j?void 0:t}}const W=y?y.emptyScript:"";class G extends V{constructor(){super(...arguments),this.type=4}C(t){t&&t!==j?this.element.setAttribute(this.name,W):this.element.removeAttribute(this.name)}}class F extends V{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=z(this,t,e,0))&&void 0!==i?i:j)===M)return;const s=this._$AH,o=t===j&&s!==j||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==j&&(s===j||o);o&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class q{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){z(this,t)}}const J=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function At(t,e,i){return t?e():null==i?void 0:i()}class Ct extends Z{render(){this.hass=this.main.hass,this.entityId=this.main.activePlayer,this.config=this.main.config,this.mediaControlService=this.main.mediaControlService,this.hassService=this.main.hassService;const t=this.getEntityAttributes(),e=ot(this.hass.states[this.entityId]).length>1;let i=[];return e&&(i=ot(this.hass.states[this.entityId]).map((t=>this.getVolumeTemplate(t,st(this.hass,this.config,t),e,!0)))),I`
    ...
    `}async volumeDownClicked(){await this.mediaControlService.volumeDown(this.entityId,this.members)}allVolumesIcon(){return this.main.showVolumes?"mdi:arrow-collapse-vertical":"mdi:arrow-expand-vertical"}shuffleIcon(){return this.getEntityAttributes().shuffle?"mdi:shuffle-variant":"mdi:shuffle-disabled"}async shuffleClicked(){await this.mediaControlService.shuffle(this.entityId,!this.getEntityAttributes().shuffle)}async repeatClicked(){await this.mediaControlService.repeat(this.entityId,this.getEntityAttributes().repeat)}repeatIcon(){const t=this.hass.states[this.entityId];return"all"===t.attributes.repeat?"mdi:repeat":"one"===t.attributes.repeat?"mdi:repeat-once":"mdi:repeat-off"}async volumeUp(){await this.mediaControlService.volumeUp(this.entityId,this.members)}clickableIcon(t,e,i=!1,s){return I`
      <ha-icon
        @click="${e}"
 ...
 */class Pt extends Z{render(){const t=this.main.config,e=this.main.hass.states[this.group.entity],i=`${e.attributes.media_artist||""} - ${e.attributes.media_title||""}`.replace(/^ - /g,""),s=ot(e).map((e=>st(this.main.hass,t,e))).join(" + ");return I`
    ...
    `}}t([tt()],Et.prototype,"main",void 0),t([tt()],Et.prototype,"activePlayer",void 0),t([tt()],Et.prototype,"groups",void 0),t([tt()],Et.prototype,"mediaPlayers",void 0),customElements.define("sonos-groups",Et);class Tt extends Z{render(){this.config=this.main.config;const t=this.main.activePlayer,e=this.mediaPlayers.filter((e=>e!==t&&this.groups[t].members[e])),i=this.mediaPlayers.filter((e=>e!==t&&!this.groups[t].members[e]));return I`
      <div style="${this.membersStyle()}">
        ${t&&this.mediaPlayers.map((i=>this.renderMediaPlayerGroupButton(i,t,e)))}
        ${At(i.length,(()=>this.getButton((async()=>await this.main.mediaControlService.join(t,i)),"mdi:checkbox-multiple-marked-outline")))}
        ${At(e.length,(()=>this.getButton((async()=>await this.main.mediaControlService.unjoin(e)),"mdi:minus-box-multiple-outline")))}
      </div>
      ${At(this.config.predefinedGroups,(()=>this.renderPredefinedGroup()))}
    `}renderMediaPlayerGroupButton(t,e,i){const s=st(this.main.hass,this.config,t);return this.groups[e].members[t]||t===e&&i.length>0?this.getButton((async()=>await this.main.mediaControlService.unjoin([t])),"mdi:minus",s):t!==e?this.getButton((async()=>await this.main.mediaControlService.join(e,[t])),"mdi:plus",s):I``}renderPredefinedGroup(){var t;return I`
      <div style="${this.main.stylable("title",xt)}">
    ...
    `}}t([tt()],Mt.prototype,"main",void 0),t([tt()],Mt.prototype,"mediaBrowser",void 0),t([tt()],Mt.prototype,"browse",void 0),t([tt()],Mt.prototype,"currentDir",void 0),customElements.define("sonos-media-browser-header",Mt);class jt extends Z{constructor(){super(...arguments),this.mediaItems=[],this.parentDirs=[]}render(){this.config=this.main.config,this.activePlayer=this.main.activePlayer,this.mediaControlService=this.main.mediaControlService,this.mediaBrowseService=this.main.mediaBrowseService;const t=localStorage.getItem("custom-sonos-card_currentDir");return t&&(this.currentDir=JSON.parse(t),this.browse=!0),I`
